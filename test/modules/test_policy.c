...
void test_status_change_request_sysadmin_allows_any()
{
  ...
  set_session_context(USER_ROLE_SYSADMIN, 1, "admin", "");
  assert(ensure_status_change_request_is_allowed(member_b) == true);
  clear_session_context();
}
...
void test_status_change_request_trainer_own_branch_allows()
{
  ...
  set_session_context(USER_ROLE_TRAINER, 1, "trA", BRANCH_A);
  assert(ensure_status_change_request_is_allowed(member_a) == true);
  clear_session_context();
}
...
void test_status_change_request_trainer_other_branch_denies()
{
  ...
  set_session_context(USER_ROLE_TRAINER, 1, "trA", BRANCH_A);
  assert(ensure_status_change_request_is_allowed(member_b) == false);
  clear_session_context();
}
...
void test_status_change_request_manager_denies()
{
  ...
  set_session_context(USER_ROLE_BRANCH_MANAGER, manager_a, STAFF_A, BRANCH_A);
  assert(ensure_status_change_request_is_allowed(member_a) == false);
  clear_session_context();
}
...
void test_status_change_request_unknown_member_id_denies()
{
  ...
  set_session_context(USER_ROLE_TRAINER, 1, "trA", BRANCH_A);
  assert(ensure_status_change_request_is_allowed(9999) == false);
  clear_session_context();
}
...
void test_plan_change_request_sysadmin_allows_any()
{
  ...
  set_session_context(USER_ROLE_SYSADMIN, 1, "admin", "");
  assert(ensure_plan_change_request_is_allowed(member_a) == true);
  clear_session_context();
}
...
void test_plan_change_request_member_other_denies()
{
  ...
  assert(ensure_plan_change_request_is_allowed(member_a) == false);
  clear_session_context();
}
...
void test_profile_edit_request_sysadmin_allows_any()
{
  ...
  set_session_context(USER_ROLE_SYSADMIN, 1, "admin", "");
  assert(ensure_profile_edit_request_is_allowed(member_a) == true);
  clear_session_context();
}
...
void test_profile_edit_request_member_other_denies()
{
  ...
  set_session_context(USER_ROLE_MEMBER, member_b, MEMBER_B, BRANCH_B);
  assert(ensure_profile_edit_request_is_allowed(member_a) == false);
  clear_session_context();
}
